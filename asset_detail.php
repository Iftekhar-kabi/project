...
<div class="w3-main" id="main" style="margin-left:260px;">
...
?>  
            <tr class="item">  
            <td id="<?php echo $row["ID"]; ?>" class="ac_machine" onclick='myk();'><?php echo $row["ID"]; ?></td>  
...
?>  
            <tr class="item">  
            <td id="<?php echo $row["ID"]; ?>" class="equipment_labour_room" onclick='myk();'><?php echo $row["ID"]; ?></td>  
...
?>  
            <tr class="item">  
            <td id="<?php echo $row["ID"]; ?>" class="equipment_icu" onclick='myk();'><?php echo $row["ID"]; ?></td>  
...
?>  
 ...
 <td onBlur="saveToDatabase(this,'AMC',<?php echo $row["ID"]; ?>,'phyjiotherepy_instrument')"ondblclick="showEdit(this);"><?php echo $row["STATUS"]; ?></td>
<td><a  class="w3-button w3-indigo w3-round-large" href="">Edit</a></td>
