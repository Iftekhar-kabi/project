...
$amc=$_POST['amc'];
 $sql = "INSERT INTO television(LOCATION,MAKE,YEAR_OF_PURCHASE,COST_OF_PURCHASE,WARRANTY_PERIOD,AMC_DETAIL)VALUES('$location','$make','$yearpurchase','$costpurchase','$warranty','$amc')";
...
$daterenewalamc=$_POST['daterenewalamc'];
 ...
 $sql = "INSERT INTO printers(LOCATION,PRINTER_TYPE,YEAR_OF_PURCHASE,COST,WARRANTY,MODEL,AMC_WITH,COST_OF_AMC,RENEWAL_DATE)VALUES('$location','$printer','$yearpurchase','$costpurchase','$warranty','$model','$amc','$costamc','$daterenewalamc')";
if (mysqli_query($con, $sql)) {
    echo "New record created successfully";
} else {
    ?>
...
$warranty=$_POST['warranty'];
 ...
 $sql = "INSERT INTO  motors(MAKE,LOCATION,YEAR_OF_PURCHASE,WARRANTY,COST,MODEL,CONFIGURATION,AMC_WITH,Cost_of_AMC,MAINTENANCE)VALUES('$make','$location','$yearpurchase','$warranty','$costpurchase','$model','$configuration','$amc','$costamc','$maintain')";
if (mysqli_query($con, $sql)) {
    echo "New record created successfully";
} else {
    ?>
...
$general=$_POST['general'];
 ...
 $sql = "INSERT INTO  generators(MAKE,SERIAL_NO,WATTS,CONFIGURATION,YEAR_OF_PURCHASE,AMC_WITH,COST_OF_AMC,OIL_CHANGE,GENERAL_SERVICING)VALUES('$make','$serial','$watts','$configuration','$yearpurchase','$amc','$costamc','$oilchange','$general')";
if (mysqli_query($con, $sql)) {
    echo "New record created successfully";
} else {
    ?>
...
$daterenewalamc=$_POST['daterenewalamc'];
 ...
 $sql = "INSERT INTO cctv_camera(LOCATION,FLOOR,MAKE,YEAR_OF_PURCHASE,COST_OF_PURCHASE,AMC_WITH,COST_OF_AMC,DATE_AMC_RENEWAL)VALUES('$location','$floor','$make','$yearpurchase','$costpurchase','$amc','$costamc','$daterenewalamc')";
if (mysqli_query($con, $sql)) {
    echo "New record created successfully";
} else {
    echo "Error: " . $sql . "<br>" . mysqli_error($con);
...
$suplier=$_POST['suplier'];
 ...
 $sql = "INSERT INTO xerox_machine(MAKE,LOCATION,SUPPLIER,YEAR_OF_PURCHASE,COST)VALUES('$make','$location','$suplier','$yearpurchase','$costpurchase')";
if (mysqli_query($con, $sql)) {
    echo "New record created successfully";
} else {
    echo "Error: " . $sql . "<br>" . mysqli_error($con);
