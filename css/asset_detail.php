...
<span><button style="background-color:#052559;color:#ffffff;float:right;margin-top:15px;margin-right:5px;"onclick="goBack()" type="submit" class="btn btn-default">Go Back
		   </button></span>
<?php
if($_GET['name']==1)
{
...
?>  
            <tr class="item">  
            <td><?php echo $row["ID"]; ?></td>  
            <td onBlur="saveToDatabase(this,'EQUIPMENT_NAME',<?php echo $row["ID"]; ?>,'equipment_icu')"ondblclick="showEdit(this);"contenteditable><?php echo $row["EQUIPMENT_NAME"]; ?></td> 
			    <td onBlur="saveToDatabase(this,'MANUFACTURER',<?php echo $row["ID"]; ?>,'equipment_icu')"ondblclick="showEdit(this);"contenteditable><?php echo $row["MANUFACTURER"]; ?></td> 
				<td onBlur="saveToDatabase(this,'MODEL',<?php echo $row["ID"]; ?>,'equipment_icu')"ondblclick="showEdit(this);"contenteditable><?php echo $row["MODEL"]; ?></td> 
				 <td onBlur="saveToDatabase(this,'SERIAL_NO',<?php echo $row["ID"]; ?>,'equipment_icu')"ondblclick="showEdit(this);"contenteditable><?php echo $row["SERIAL_NO"]; ?></td>
				 <td onBlur="saveToDatabase(this,'SUPPLIER',<?php echo $row["ID"]; ?>,'equipment_icu')"ondblclick="showEdit(this);"contenteditable><?php echo $row["SUPPLIER"]; ?></td>
				 <td onBlur="saveToDatabase(this,'DATE_OF_PURCHASE',<?php echo $row["ID"]; ?>,'equipment_icu')"ondblclick="showEdit(this);"contenteditable><?php echo $row["DATE_OF_PURCHASE"]; ?></td>
				 <td onBlur="saveToDatabase(this,'COST_OF_MACHINE',<?php echo $row["ID"]; ?>,'equipment_icu')"ondblclick="showEdit(this);"contenteditable><?php echo $row["COST_OF_MACHINE"]; ?></td>
				 <td onBlur="saveToDatabase(this,'INV_NO_DATE',<?php echo $row["ID"]; ?>,'equipment_icu')"ondblclick="showEdit(this);"contenteditable><?php echo $row["INV_NO_DATE"]; ?></td>
				 <td onBlur="saveToDatabase(this,'INSTALLATION_DATE',<?php echo $row["ID"]; ?>,'equipment_icu')"ondblclick="showEdit(this);"contenteditable><?php echo $row["INSTALLATIO_DATE"]; ?></td>
				 <td onBlur="saveToDatabase(this,'LOCATION',<?php echo $row["ID"]; ?>,'equipment_icu')"ondblclick="showEdit(this);"contenteditable><?php echo $row["LOCATION"]; ?></td>
				 <td onBlur="saveToDatabase(this,'WARRANTY_PERIOD',<?php echo $row["ID"]; ?>,'equipment_icu')"ondblclick="showEdit(this);"contenteditable><?php echo $row["WARRANTY_PERIOD"]; ?></td>
				 <td onBlur="saveToDatabase(this,'WARRANTY_END_DATE',<?php echo $row["ID"]; ?>,'equipment_icu')"ondblclick="showEdit(this);"contenteditable><?php echo $row["WARRANTY_END_DATE"]; ?></td>
				 <td onBlur="saveToDatabase(this,'AMC',<?php echo $row["ID"]; ?>,'equipment_icu')"ondblclick="showEdit(this);"contenteditable><?php echo $row["AMC"]; ?></td>
				 <td onBlur="saveToDatabase(this,'CMC',<?php echo $row["ID"]; ?>,'equipment_icu')"ondblclick="showEdit(this);"contenteditable><?php echo $row["CMC"]; ?></td>
				 <td onBlur="saveToDatabase(this,'AMC_CMC_PERIOD',<?php echo $row["ID"]; ?>,'equipment_icu')"ondblclick="showEdit(this);"contenteditable><?php echo $row["AMC_CMC_PERIOD"]; ?></td>
				 <td onBlur="saveToDatabase(this,'AMC_CMC_ENDDATE',<?php echo $row["ID"]; ?>,'equipment_icu')"ondblclick="showEdit(this);"contenteditable><?php echo $row["AMC_CMC_ENDDATE"]; ?></td>
				 <td onBlur="saveToDatabase(this,'AMC_CMC_AMOUNT',<?php echo $row["ID"]; ?>,'equipment_icu')"ondblclick="showEdit(this);"contenteditable><?php echo $row["AMC_CMC_AMOUNT"]; ?></td>
				 <td onBlur="saveToDatabase(this,'FREQUENCY_TO_PM',<?php echo $row["ID"]; ?>,'equipment_icu')"ondblclick="showEdit(this);"contenteditable><?php echo $row["FREQUENCY_TO_PM"]; ?></td>
				 <td onBlur="saveToDatabase(this,'LAST_SERVICE_DATE',<?php echo $row["ID"]; ?>,'equipment_icu')"ondblclick="showEdit(this);"contenteditable><?php echo $row["LAST_SERVICE_DATE"]; ?></td>
				 <td onBlur="saveToDatabase(this,'SPARE_ACCESSORIES_REPLACED_ON',<?php echo $row["ID"]; ?>,'equipment_icu')"ondblclick="showEdit(this);"contenteditable><?php echo $row["SPARE_ACCESSORIES_REPLACED_ON"]; ?></td>
				 <td onBlur="saveToDatabase(this,'STATUS',<?php echo $row["ID"]; ?>,'equipment_icu')"ondblclick="showEdit(this);"contenteditable><?php echo $row["STATUS"]; ?></td>
<td><a  class="w3-button w3-indigo w3-round-large" href="">Edit</a></td>
...
?>  
            <tr class="item">  
            <td><?php echo $row["ID"]; ?></td>  
            <td onBlur="saveToDatabase(this,'EQUIPMENT',<?php echo $row["ID"]; ?>,'equipment_pow')"ondblclick="showEdit(this);"contenteditable><?php echo $row["EQUIPMENT"]; ?></td> 
			    <td onBlur="saveToDatabase(this,'MANUFACTURER',<?php echo $row["ID"]; ?>,'equipment_pow')"ondblclick="showEdit(this);"contenteditable><?php echo $row["MANUFACTURER"]; ?></td> 
				<td onBlur="saveToDatabase(this,'MODEL',<?php echo $row["ID"]; ?>,'equipment_pow')"ondblclick="showEdit(this);"contenteditable><?php echo $row["MODEL"]; ?></td> 
				 <td onBlur="saveToDatabase(this,'SERIAL_NO',<?php echo $row["ID"]; ?>,'equipment_pow')"ondblclick="showEdit(this);"contenteditable><?php echo $row["SERIAL_NO"]; ?></td>
				 <td onBlur="saveToDatabase(this,'SUPPLIER',<?php echo $row["ID"]; ?>,'equipment_pow')"ondblclick="showEdit(this);"contenteditable><?php echo $row["SUPPLIER"]; ?></td>
				 <td onBlur="saveToDatabase(this,'DATE_OF_PURCHASE',<?php echo $row["ID"]; ?>,'equipment_pow')"ondblclick="showEdit(this);"contenteditable><?php echo $row["DATE_OF_PURCHASE"]; ?></td>
				 <td onBlur="saveToDatabase(this,'COST_OF_MACHINE',<?php echo $row["ID"]; ?>,'equipment_pow')"ondblclick="showEdit(this);"contenteditable><?php echo $row["COST_OF_MACHINE"]; ?></td>
				 <td onBlur="saveToDatabase(this,'INV_NO_DATE',<?php echo $row["ID"]; ?>,'equipment_pow')"ondblclick="showEdit(this);"contenteditable><?php echo $row["INV_NO_DATE"]; ?></td>
				 <td onBlur="saveToDatabase(this,'DATE_INSTALLATION',<?php echo $row["ID"]; ?>,'equipment_pow')"ondblclick="showEdit(this);"contenteditable><?php echo $row["DATE_INSTALLATION"]; ?></td>
				 <td onBlur="saveToDatabase(this,'LOCATION',<?php echo $row["ID"]; ?>,'equipment_pow')"ondblclick="showEdit(this);"contenteditable><?php echo $row["LOCATION"]; ?></td>
				 <td onBlur="saveToDatabase(this,'WARRANTY_PERIOD',<?php echo $row["ID"]; ?>,'equipment_pow')"ondblclick="showEdit(this);"contenteditable><?php echo $row["WARRANTY_PERIOD"]; ?></td>
				 <td onBlur="saveToDatabase(this,'WARRANTY_END_DATE',<?php echo $row["ID"]; ?>,'equipment_pow')"ondblclick="showEdit(this);"contenteditable><?php echo $row["WARRANTY_END_DATE"]; ?></td>
				 <td onBlur="saveToDatabase(this,'AMC',<?php echo $row["ID"]; ?>,'equipment_pow')"ondblclick="showEdit(this);"contenteditable><?php echo $row["AMC"]; ?></td>
				 <td onBlur="saveToDatabase(this,'CMC',<?php echo $row["ID"]; ?>,'equipment_pow')"ondblclick="showEdit(this);"contenteditable><?php echo $row["CMC"]; ?></td>
				 <td onBlur="saveToDatabase(this,'AMC_OR_CMC_PERIOD',<?php echo $row["ID"]; ?>,'equipment_pow')"ondblclick="showEdit(this);"contenteditable><?php echo $row["AMC_OR_CMC_PERIOD"]; ?></td>
				 <td onBlur="saveToDatabase(this,'AMC_OR_CMC_ENDDATE',<?php echo $row["ID"]; ?>,'equipment_pow')"ondblclick="showEdit(this);"contenteditable><?php echo $row["AMC_OR_CMC_ENDDATE"]; ?></td>
				 <td onBlur="saveToDatabase(this,'AMC_OR_CMC_AMOUNT',<?php echo $row["ID"]; ?>,'equipment_pow')"ondblclick="showEdit(this);"contenteditable><?php echo $row["AMC_OR_CMC_AMOUNT"]; ?></td>
				 <td onBlur="saveToDatabase(this,'FREQUENCY_TO_PM',<?php echo $row["ID"]; ?>,'equipment_pow')"ondblclick="showEdit(this);"contenteditable><?php echo $row["FREQUENCY_TO_PM"]; ?></td>
				 <td onBlur="saveToDatabase(this,'LAST_SERVICE_DETAIL',<?php echo $row["ID"]; ?>,'equipment_pow')"ondblclick="showEdit(this);"contenteditable><?php echo $row["LAST_SERVICE_DETAIL"]; ?></td>
				 <td onBlur="saveToDatabase(this,'SPARE_ACCESSORIES_REPLACED_ON',<?php echo $row["ID"]; ?>,'equipment_pow')"ondblclick="showEdit(this);"contenteditable><?php echo $row["SPARE_ACCESSORIES_REPLACED_ON"]; ?></td>
				 <td onBlur="saveToDatabase(this,'STATUS',<?php echo $row["ID"]; ?>,'equipment_pow')"ondblclick="showEdit(this);"contenteditable><?php echo $row["STATUS"]; ?></td>
<td><a  class="w3-button w3-indigo w3-round-large" href="">Edit</a></td>
...
?>  
            <tr class="item">  
            <td><?php echo $row["ID"]; ?></td>  
            <td onBlur="saveToDatabase(this,'NAME',<?php echo $row["ID"]; ?>,'phyjiotherepy_instrument')"ondblclick="showEdit(this);"contenteditable><?php echo $row["NAME"]; ?></td> 
			    <td onBlur="saveToDatabase(this,'MAKE',<?php echo $row["ID"]; ?>,'phyjiotherepy_instrument')"ondblclick="showEdit(this);"contenteditable><?php echo $row["MAKE"]; ?></td> 
				<td onBlur="saveToDatabase(this,'ID_NO',<?php echo $row["ID"]; ?>,'phyjiotherepy_instrument')"ondblclick="showEdit(this);"contenteditable><?php echo $row["ID_NO"]; ?></td> 
				 <td onBlur="saveToDatabase(this,'YEAR_OF_PURCHASE',<?php echo $row["ID"]; ?>,'phyjiotherepy_instrument')"ondblclick="showEdit(this);"contenteditable><?php echo $row["YEAR_OF_PURCHASE"]; ?></td>
				 <td onBlur="saveToDatabase(this,'COST_OF_PURCHASE',<?php echo $row["ID"]; ?>,'phyjiotherepy_instrument')"ondblclick="showEdit(this);"contenteditable><?php echo $row["COST_OF_PURCHASE"]; ?></td>
				 <td onBlur="saveToDatabase(this,'WARRANTY',<?php echo $row["ID"]; ?>,'phyjiotherepy_instrument')"ondblclick="showEdit(this);"contenteditable><?php echo $row["WARRANTY"]; ?></td>
				 <td onBlur="saveToDatabase(this,'AMC',<?php echo $row["ID"]; ?>,'phyjiotherepy_instrument')"ondblclick="showEdit(this);"contenteditable><?php echo $row["AMC"]; ?></td>
<td><a  class="w3-button w3-indigo w3-round-large" href="">Edit</a></td>
...
?>  
            <tr class="item">  
            <td><?php echo $row["ID"]; ?></td>  
            <td onBlur="saveToDatabase(this,'LOCATION',<?php echo $row["ID"]; ?>,'cctv_camera')"ondblclick="showEdit(this);"contenteditable><?php echo $row["LOCATION"]; ?></td> 
			    <td onBlur="saveToDatabase(this,'FLOOR',<?php echo $row["ID"]; ?>,'cctv_camera')"ondblclick="showEdit(this);"contenteditable><?php echo $row["FLOOR"]; ?></td> 
				<td onBlur="saveToDatabase(this,'MAKE',<?php echo $row["ID"]; ?>,'cctv_camera')"ondblclick="showEdit(this);"contenteditable><?php echo $row["MAKE"]; ?></td> 
				 <td onBlur="saveToDatabase(this,'YEAR_OF_PURCHASE',<?php echo $row["ID"]; ?>,'cctv_camera')"ondblclick="showEdit(this);"contenteditable><?php echo $row["YEAR_OF_PURCHASE"]; ?></td>
				 <td onBlur="saveToDatabase(this,'COST_OF_PURCHASE',<?php echo $row["ID"]; ?>,'cctv_camera')"ondblclick="showEdit(this);"contenteditable><?php echo $row["COST_OF_PURCHASE"]; ?></td>
				 <td onBlur="saveToDatabase(this,'AMC_WITH',<?php echo $row["ID"]; ?>,'cctv_camera')"ondblclick="showEdit(this);"contenteditable><?php echo $row["AMC_WITH"]; ?></td>
				 <td onBlur="saveToDatabase(this,'COST_OF_AMC',<?php echo $row["ID"]; ?>,'cctv_camera')"ondblclick="showEdit(this);"contenteditable><?php echo $row["COST_OF_AMC"]; ?></td>
				 <td onBlur="saveToDatabase(this,'DATE_AMC_RENEWAL',<?php echo $row["ID"]; ?>,'cctv_camera')"ondblclick="showEdit(this);"contenteditable><?php echo $row["DATE_AMC_RENEWAL"]; ?></td>
<td><a  class="w3-button w3-indigo w3-round-large" href="">Edit</a></td>
...
?>  
            <tr class="item">  
            <td><?php echo $row["ID"]; ?></td>  
            <td onBlur="saveToDatabase(this,'MAKE',<?php echo $row["ID"]; ?>,'xerox_machine')"ondblclick="showEdit(this);"contenteditable><?php echo $row["MAKE"]; ?></td> 
			    <td onBlur="saveToDatabase(this,'LOCATION',<?php echo $row["ID"]; ?>,'xerox_machine')"ondblclick="showEdit(this);"contenteditable><?php echo $row["LOCATION"]; ?></td> 
				<td onBlur="saveToDatabase(this,'SUPPLIER',<?php echo $row["ID"]; ?>,'xerox_machine')"ondblclick="showEdit(this);"contenteditable><?php echo $row["SUPPLIER"]; ?></td> 
				 <td onBlur="saveToDatabase(this,'YEAR_OF_PURCHASE',<?php echo $row["ID"]; ?>,'xerox_machine')"ondblclick="showEdit(this);"contenteditable><?php echo $row["YEAR_OF_PURCHASE"]; ?></td>
				 <td onBlur="saveToDatabase(this,'COST',<?php echo $row["ID"]; ?>,'xerox_machine')"ondblclick="showEdit(this);"contenteditable><?php echo $row["COST"]; ?></td>
<td><a  class="w3-button w3-indigo w3-round-large" href="">Edit</a></td>
...
?>  
            <tr class="item">  
            <td><?php echo $row["ID"]; ?></td>  
            <td onBlur="saveToDatabase(this,'LOCATION',<?php echo $row["ID"]; ?>,'telephone')"ondblclick="showEdit(this);"contenteditable><?php echo $row["LOCATION"]; ?></td> 
			    <td onBlur="saveToDatabase(this,'TELEPHONE_NO',<?php echo $row["ID"]; ?>,'telephone')"ondblclick="showEdit(this);"contenteditable><?php echo $row["TELEPHONE_NO"]; ?></td> 
				<td onBlur="saveToDatabase(this,'AMC',<?php echo $row["ID"]; ?>,'telephone')"ondblclick="showEdit(this);"contenteditable><?php echo $row["AMC"]; ?></td> 
				 <td onBlur="saveToDatabase(this,'COST_OF_AMC',<?php echo $row["ID"]; ?>,'telephone')"ondblclick="showEdit(this);"contenteditable><?php echo $row["COST_OF_AMC"]; ?></td>
				 <td onBlur="saveToDatabase(this,'DATE_RENEWAL_AMC',<?php echo $row["ID"]; ?>,'telephone')"ondblclick="showEdit(this);"contenteditable><?php echo $row["DATE_RENEWAL_AMC"]; ?></td>
				 <td onBlur="saveToDatabase(this,'STATUS',<?php echo $row["ID"]; ?>,'telephone')"ondblclick="showEdit(this);"contenteditable><?php echo $row["STATUS"]; ?></td>
<td><a  class="w3-button w3-indigo w3-round-large" href="">Edit</a></td>
...
?>  
            <tr class="item">  
            <td><?php echo $row["ID"]; ?></td>  
            <td onBlur="saveToDatabase(this,'LOCATION',<?php echo $row["ID"]; ?>,'television')"ondblclick="showEdit(this);"contenteditable><?php echo $row["LOCATION"]; ?></td> 
			    <td onBlur="saveToDatabase(this,'MAKE',<?php echo $row["ID"]; ?>,'television')"ondblclick="showEdit(this);"contenteditable><?php echo $row["MAKE"]; ?></td> 
				<td onBlur="saveToDatabase(this,'YEAR_OF_PURCHASE',<?php echo $row["ID"]; ?>,'television')"ondblclick="showEdit(this);"contenteditable><?php echo $row["YEAR_OF_PURCHASE"]; ?></td> 
				 <td onBlur="saveToDatabase(this,'COST_OF_PURCHASE',<?php echo $row["ID"]; ?>,'television')"ondblclick="showEdit(this);"contenteditable><?php echo $row["COST_OF_PURCHASE"]; ?></td>
				 <td onBlur="saveToDatabase(this,'WARRANTY_PERIOD',<?php echo $row["ID"]; ?>,'television')"ondblclick="showEdit(this);"contenteditable><?php echo $row["WARRANTY_PERIOD"]; ?></td>
				 <td onBlur="saveToDatabase(this,'AMC_DETAIL',<?php echo $row["ID"]; ?>,'television')"ondblclick="showEdit(this);"contenteditable><?php echo $row["AMC_DETAIL"]; ?></td>
<td><a  class="w3-button w3-indigo w3-round-large" href="">Edit</a></td>
...
?>  
            <tr class="item">  
            <td><?php echo $row["ID"]; ?></td>  
            <td onBlur="saveToDatabase(this,'LOCATION',<?php echo $row["ID"]; ?>,'printers')"ondblclick="showEdit(this);"contenteditable><?php echo $row["LOCATION"]; ?></td> 
			    <td onBlur="saveToDatabase(this,'PRINTER_TYPE',<?php echo $row["ID"]; ?>,'printers')"ondblclick="showEdit(this);"contenteditable><?php echo $row["PRINTER_TYPE"]; ?></td> 
				<td onBlur="saveToDatabase(this,'YEAR_OF_PURCHASE',<?php echo $row["ID"]; ?>,'printers')"ondblclick="showEdit(this);"contenteditable><?php echo $row["YEAR_OF_PURCHASE"]; ?></td> 
				 <td onBlur="saveToDatabase(this,'COST',<?php echo $row["ID"]; ?>,'printers')"ondblclick="showEdit(this);"contenteditable><?php echo $row["COST"]; ?></td>
				 <td onBlur="saveToDatabase(this,'WARRANTY',<?php echo $row["ID"]; ?>,'printers')"ondblclick="showEdit(this);"contenteditable><?php echo $row["WARRANTY"]; ?></td>
				 <td onBlur="saveToDatabase(this,'MODEL',<?php echo $row["ID"]; ?>,'printers')"ondblclick="showEdit(this);"contenteditable><?php echo $row["MODEL"]; ?></td>
				 <td onBlur="saveToDatabase(this,'AMC_WITH',<?php echo $row["ID"]; ?>,'printers')"ondblclick="showEdit(this);"contenteditable><?php echo $row["AMC_WITH"]; ?></td>
				 <td onBlur="saveToDatabase(this,'COST_OF_AMC',<?php echo $row["ID"]; ?>,'printers')"ondblclick="showEdit(this);"contenteditable><?php echo $row["COST_OF_AMC"]; ?></td>
				 <td onBlur="saveToDatabase(this,'RENEWAL_DATE',<?php echo $row["ID"]; ?>,'printers')"ondblclick="showEdit(this);"contenteditable><?php echo $row["RENEWAL_DATE"]; ?></td>
<td><a  class="w3-button w3-indigo w3-round-large" href="">Edit</a></td>
...
?>  
            <tr class="item">  
            <td><?php echo $row["ID"]; ?></td>  
            <td onBlur="saveToDatabase(this,'MAKE',<?php echo $row["ID"]; ?>,'generators')" ondblclick="showEdit(this);"contenteditable><?php echo $row["MAKE"]; ?></td> 
			    <td onBlur="saveToDatabase(this,'SERIAL_NO',<?php echo $row["ID"]; ?>,'generators')" ondblclick="showEdit(this);"contenteditable><?php echo $row["SERIAL_NO"]; ?></td> 
				<td onBlur="saveToDatabase(this,'WATTS',<?php echo $row["ID"]; ?>,'generators')" ondblclick="showEdit(this);"contenteditable><?php echo $row["WATTS"]; ?></td> 
				 <td onBlur="saveToDatabase(this,'CONFIGURATION',<?php echo $row["ID"]; ?>,'generators')" ondblclick="showEdit(this);"contenteditable><?php echo $row["CONFIGURATION"]; ?></td>
				 <td onBlur="saveToDatabase(this,'YEAR_OF_PURCHASE',<?php echo $row["ID"]; ?>,'generators')" ondblclick="showEdit(this);"contenteditable><?php echo $row["YEAR_OF_PURCHASE"]; ?></td>
				 <td onBlur="saveToDatabase(this,'AMC_WITH',<?php echo $row["ID"]; ?>,'generators')" ondblclick="showEdit(this);"contenteditable><?php echo $row["AMC_WITH"]; ?></td>
				 <td onBlur="saveToDatabase(this,'COST_OF_AMC',<?php echo $row["ID"]; ?>,'generators')" ondblclick="showEdit(this);"contenteditable><?php echo $row["COST_OF_AMC"]; ?></td>
				 <td onBlur="saveToDatabase(this,'OIL_CHANGE',<?php echo $row["ID"]; ?>,'generators')" ondblclick="showEdit(this);"contenteditable><?php echo $row["OIL_CHANGE"]; ?></td>
				 <td style="white-space:normal;" onBlur="saveToDatabase(this,'GENERAL_SERVICING',<?php echo $row["ID"]; ?>,'generators')" ondblclick="showEdit(this);"contenteditable><?php echo $row["GENERAL_SERVICING"]; ?></td>
<td><a  class="w3-button w3-indigo w3-round-large" href="">Edit</a></td>
...
?>  
            <tr class="item">  
            <td><?php echo $row["ID"]; ?></td>  
            <td onBlur="saveToDatabase(this,'EQUIPMENT',<?php echo $row["ID"]; ?>,'equipment_ot')"ondblclick="showEdit(this);"contenteditable><?php echo $row["EQUIPMENT"]; ?></td> 
			    <td onBlur="saveToDatabase(this,'MANUFACTURER',<?php echo $row["ID"]; ?>,'equipment_ot')"ondblclick="showEdit(this);"contenteditable><?php echo $row["MANUFACTURER"]; ?></td> 
				<td onBlur="saveToDatabase(this,'MODEL',<?php echo $row["ID"]; ?>,'equipment_ot')"ondblclick="showEdit(this);"contenteditable><?php echo $row["MODEL"]; ?></td> 
				 <td onBlur="saveToDatabase(this,'SERIAL_NO',<?php echo $row["ID"]; ?>,'equipment_ot')"ondblclick="showEdit(this);"contenteditable><?php echo $row["SERIAL_NO"]; ?></td>
				 <td onBlur="saveToDatabase(this,'SUPPLIER',<?php echo $row["ID"]; ?>,'equipment_ot')"ondblclick="showEdit(this);"contenteditable><?php echo $row["SUPPLIER"]; ?></td>
				 <td onBlur="saveToDatabase(this,'DATE_OF_PURCHASE',<?php echo $row["ID"]; ?>,'equipment_ot')"ondblclick="showEdit(this);"contenteditable><?php echo $row["DATE_OF_PURCHASE"]; ?></td>
				 <td onBlur="saveToDatabase(this,'COST_OF_MACHINE',<?php echo $row["ID"]; ?>,'equipment_ot')"ondblclick="showEdit(this);"contenteditable><?php echo $row["COST_OF_MACHINE"]; ?></td>
				 <td onBlur="saveToDatabase(this,'INV_NO_DATE',<?php echo $row["ID"]; ?>,'equipment_ot')"ondblclick="showEdit(this);"contenteditable><?php echo $row["INV_NO_DATE"]; ?></td>
				 <td onBlur="saveToDatabase(this,'DATE_INSTALLATION',<?php echo $row["ID"]; ?>,'equipment_ot')"ondblclick="showEdit(this);"contenteditable><?php echo $row["DATE_INSTALLATION"]; ?></td>
				 <td onBlur="saveToDatabase(this,'LOCATION',<?php echo $row["ID"]; ?>,'equipment_ot')"ondblclick="showEdit(this);"contenteditable><?php echo $row["LOCATION"]; ?></td>
				 <td onBlur="saveToDatabase(this,'WARRANTY_PERIOD',<?php echo $row["ID"]; ?>,'equipment_ot')"ondblclick="showEdit(this);"contenteditable><?php echo $row["WARRANTY_PERIOD"]; ?></td>
				 <td onBlur="saveToDatabase(this,'WARRANTY_END_DATE',<?php echo $row["ID"]; ?>,'equipment_ot')"ondblclick="showEdit(this);"contenteditable><?php echo $row["WARRANTY_END_DATE"]; ?></td>
				 <td onBlur="saveToDatabase(this,'AMC',<?php echo $row["ID"]; ?>,'equipment_ot')"ondblclick="showEdit(this);"contenteditable><?php echo $row["AMC"]; ?></td>
				 <td onBlur="saveToDatabase(this,'CMC',<?php echo $row["ID"]; ?>,'equipment_ot')"ondblclick="showEdit(this);"contenteditable><?php echo $row["CMC"]; ?></td>
				 <td onBlur="saveToDatabase(this,'AMC_OR_CMC_PERIOD',<?php echo $row["ID"]; ?>,'equipment_ot')"ondblclick="showEdit(this);"contenteditable><?php echo $row["AMC_OR_CMC_PERIOD"]; ?></td>
				 <td onBlur="saveToDatabase(this,'AMC_OR_CMC_ENDDATE',<?php echo $row["ID"]; ?>,'equipment_ot')"ondblclick="showEdit(this);"contenteditable><?php echo $row["AMC_OR_CMC_ENDDATE"]; ?></td>
				 <td onBlur="saveToDatabase(this,'AMC_OR_CMC_AMOUNT',<?php echo $row["ID"]; ?>,'equipment_ot')"ondblclick="showEdit(this);"contenteditable><?php echo $row["AMC_OR_CMC_AMOUNT"]; ?></td>
				 <td onBlur="saveToDatabase(this,'FREQUENCY_OF_PM',<?php echo $row["ID"]; ?>,'equipment_ot')"ondblclick="showEdit(this);"contenteditable><?php echo $row["FREQUENCY_OF_PM"]; ?></td>
				 <td onBlur="saveToDatabase(this,'LAST_SEREVICE_DETAIL',<?php echo $row["ID"]; ?>,'equipment_ot')"ondblclick="showEdit(this);"contenteditable><?php echo $row["LAST_SEREVICE_DETAIL"]; ?></td>
				 <td onBlur="saveToDatabase(this,'SPARE_ACCESSORIES_REPLACED_ON',<?php echo $row["ID"]; ?>,'equipment_ot')"ondblclick="showEdit(this);"contenteditable><?php echo $row["SPARE_ACCESSORIES_REPLACED_ON"]; ?></td>
				 <td onBlur="saveToDatabase(this,'STATUS',<?php echo $row["ID"]; ?>,'equipment_ot')"ondblclick="showEdit(this);"contenteditable><?php echo $row["STATUS"]; ?></td>
<td><a  class="w3-button w3-indigo w3-round-large" href="">Edit</a></td>
...
?>  
            <tr class="item">  
            <td><?php echo $row["ID"]; ?></td>  
            <td onBlur="saveToDatabase(this,'LOCATION',<?php echo $row["ID"]; ?>,'computers')"ondblclick="showEdit(this);"contenteditable><?php echo $row["LOCATION"]; ?></td> 
			    <td onBlur="saveToDatabase(this,'MAKE',<?php echo $row["ID"]; ?>,'computers')"ondblclick="showEdit(this);"contenteditable><?php echo $row["MAKE"]; ?></td> 
				<td onBlur="saveToDatabase(this,'NO_OF_COMPUTERS',<?php echo $row["ID"]; ?>,'computers')"ondblclick="showEdit(this);"contenteditable><?php echo $row["NO_OF_COMPUTERS"]; ?></td> 
				 <td onBlur="saveToDatabase(this,'YEAR_OF_PURCHASE',<?php echo $row["ID"]; ?>,'computers')"ondblclick="showEdit(this);"contenteditable><?php echo $row["YEAR_OF_PURCHASE"]; ?></td>
				 <td onBlur="saveToDatabase(this,'COST_OF_PURCHASE',<?php echo $row["ID"]; ?>,'computers')"ondblclick="showEdit(this);"contenteditable><?php echo $row["COST_OF_PURCHASE"]; ?></td>
				 <td onBlur="saveToDatabase(this,'COST_OF_AMC',<?php echo $row["ID"]; ?>,'computers')"ondblclick="showEdit(this);"contenteditable><?php echo $row["COST_OF_AMC"]; ?></td>
				 <td onBlur="saveToDatabase(this,'AMC_WITH',<?php echo $row["ID"]; ?>,'computers')"ondblclick="showEdit(this);"contenteditable><?php echo $row["AMC_WITH"]; ?></td>
				 <td onBlur="saveToDatabase(this,'RENEWAL_DATE_AMC',<?php echo $row["ID"]; ?>,'computers')"ondblclick="showEdit(this);"contenteditable><?php echo $row["RENEWAL_DATE_AMC"]; ?></td>
				 <td onBlur="saveToDatabase(this,'STATUS',<?php echo $row["ID"]; ?>,'computers')"ondblclick="showEdit(this);"contenteditable><?php echo $row["STATUS"]; ?></td>
<td><a  class="w3-button w3-indigo w3-round-large" href="">Edit</a></td>
...
?>  
            <tr class="item">  
            <td><?php echo $row["ID"]; ?></td>  
            <td onBlur="saveToDatabase(this,'MAKE',<?php echo $row["ID"]; ?>,'motors')"ondblclick="showEdit(this);"contenteditable><?php echo $row["MAKE"]; ?></td> 
			    <td onBlur="saveToDatabase(this,'LOCATION',<?php echo $row["ID"]; ?>,'motors')"ondblclick="showEdit(this);"contenteditable><?php echo $row["LOCATION"]; ?></td> 
				<td onBlur="saveToDatabase(this,'YEAR_OF_PURCHASE',<?php echo $row["ID"]; ?>,'motors')"ondblclick="showEdit(this);"contenteditable><?php echo $row["YEAR_OF_PURCHASE"]; ?></td> 
				 <td onBlur="saveToDatabase(this,'WARRANTY',<?php echo $row["ID"]; ?>,'motors')"ondblclick="showEdit(this);"contenteditable><?php echo $row["WARRANTY"]; ?></td>
				 <td onBlur="saveToDatabase(this,'COST',<?php echo $row["ID"]; ?>,'motors')"ondblclick="showEdit(this);"contenteditable><?php echo $row["COST"]; ?></td>
				 <td onBlur="saveToDatabase(this,'MODEL',<?php echo $row["ID"]; ?>,'motors')"ondblclick="showEdit(this);"contenteditable><?php echo $row["MODEL"]; ?></td>
				 <td onBlur="saveToDatabase(this,'CONFIGURATION',<?php echo $row["ID"]; ?>,'motors')"ondblclick="showEdit(this);"contenteditable><?php echo $row["CONFIGURATION"]; ?></td>
				 <td onBlur="saveToDatabase(this,'AMC_WITH',<?php echo $row["ID"]; ?>,'motors')"ondblclick="showEdit(this);"contenteditable><?php echo $row["AMC_WITH"]; ?></td>
				 <td onBlur="saveToDatabase(this,'COST_OF_AMC',<?php echo $row["ID"]; ?>,'motors')"ondblclick="showEdit(this);"contenteditable><?php echo $row["COST_OF_AMC"]; ?></td>
				 <td onBlur="saveToDatabase(this,'MAINTENANCE',<?php echo $row["ID"]; ?>,'motors')"ondblclick="showEdit(this);"contenteditable><?php echo $row["MAINTENANCE"]; ?></td>
<td><a  class="w3-button w3-indigo w3-round-large" href="">Edit</a></td>
